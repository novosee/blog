  ...
  function ondata() {
    ...
    switch (cubeCore.mode) {
      case CONST.GAME:
        ...
        /*boom the brain*/
        for (var index = 10; index < cubeCore.lights.length; index++) {
          cubeCore.lights[index
          ].rgb = cubeCore.lights[9].rgb;
          cubeCore.lights[index
          ].bright = cubeCore.lights[9].bright;
          cubeCore.lights[index
          ].time = 5;
        }
